...
if len(components) == 3:
    ...
    if (len(secondComponent) != 4 or not isfloat(secondComponent[2]) or float(secondComponent[2]) <= 0.0 or
            secondComponent[1] != '=' or (
                    secondComponent[0] != 'C' or secondComponent[3] != 'uF') and (
                    secondComponent[0] != 'R' or secondComponent[3] != 'Ohm') and (
                    secondComponent[0] != 'L' or secondComponent[3] != 'H')):
        print('Wrong format')
        sys.exit()

    if secondComponent[0] not in filterType.split(' ')[1]:
        print('Missing parameters')
        sys.exit()
...
if firstComponent[0] == 'C':
    ...
    if filterType1[1] == 'RC':
        ...
        L = float(firstComponent[2]) / float(frequency[2])
